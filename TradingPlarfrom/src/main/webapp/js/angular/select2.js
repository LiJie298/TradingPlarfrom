            ...
            function resolveContainerWidth() {
                ...
                if (this.opts.width === "off") {
                    ...
                    if (this.opts.width === "resolve") {
                        // next check if style('width') can resolve a width that is percent based, this is sometimes possible
                        // when attached to input type=hidden or elements hidden via style
